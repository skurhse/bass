...
`bass` is a collection of [hypertext](https://en.wikipedia.org/wiki/Hypertext) [DevOps](https://en.wikipedia.org/wiki/DevOps) flashcards, organized into the following five [software engineering](https://en.wikipedia.org/wiki/Software_engineering) concepts:
...
- [Infrastructure-as-code](https://en.wikipedia.org/wiki/Infrastructure_as_code) -  manage resources through [machine-readable](https://en.wikipedia.org/wiki/Machine-readable_document) definition files.
...
- Open-source links, [Wikipedia](https://en.wikipedia.org/wiki/Wikipedia), and IETF links are prioritized.
